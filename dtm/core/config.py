...
class config(object):
    def __init__(self):
        ...
        self.gui_data = "dtm/ressources/gui.dat"
        self.filters_pickle_path = "dtm/ressources/filters.dat"
        self.icon_path = "@dtm/ressources/favicon.XBM" if util.platform.linux else "dtm/ressources/favicon.ico"
        self.init_var()
        self.load()
